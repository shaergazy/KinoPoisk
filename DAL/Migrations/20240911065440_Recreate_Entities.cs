...
{
    /// <inheritdoc />
    public partial class Recreate_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranslatableEntity", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Countries_TranslatableEntity_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Genres_TranslatableEntity_Id",
                        column: x => x.Id,
                        principalTable: "TranslatableEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Persons_TranslatableEntity_Id",
                        column: x => x.Id,
                        principalTable: "TranslatableEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranslatableEntityFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TranslatableEntityFields_TranslatableEntity_TranslatableEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Movies_TranslatableEntity_Id",
                        column: x => x.Id,
                        principalTable: "TranslatableEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Subscription",
                newName: "IX_Subscription_SubscriptionPlanId");
